...
def async_setup_entity_entry_helper(
    ...
    def _async_setup_entities() -> None:
        ...
        for subentry_id, subentry in entry.subentries.items():
            ...
            device_config["identifiers"] = subentry_id
            for component_id, component_data in subentry_data["components"].items():
                ...
                component_config[CONF_UNIQUE_ID] = f"{subentry_id}_{component_id}"
            ...
            async_add_entities(subentry_entities, subentry_id=subentry_id)
